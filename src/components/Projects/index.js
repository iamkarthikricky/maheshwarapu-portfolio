...
class  Projects extends Component{
  ...
  onTimerChange=()=>{
    this.setState(preValue=>({redirectSeconds:preValue.redirectSeconds - 1}),this.replacePath)  
  }

  replacePath=()=>{
    const{history}=this.props
    const{redirectSeconds}=this.state
  ...
  onTimerStart=()=>{
    this.timeInterval=setInterval(this.onTimerChange,1000)
  }
